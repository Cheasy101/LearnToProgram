...
using Application.Features.Commands.Auth.GetConfirmEmail;
using Application.Features.Commands.Auth.PostLogin;
using Application.Features.Commands.Auth.PostRegister;
using Application.Features.Commands.Auth.PostResetPassword;
using Application.Features.Commands.Auth.PostResetPasswordConfirm;
using MediatR;
